...
$js = "";
if ( $use_popup_windows ) $js .= get_js_open_window( 900, 500 );
if ( $use_date_picker ) $js .= get_js_date_picker();
...
function handle_submit( &$selected_id )
{
    ...
    {  //it is a new customer
        ...
        if ( isset( $auto_create_branch ) && $auto_create_branch == 1 ) display_notification( _( "A default Branch has been automatically created, please check default Branch values by using link below." ) );
...
function customer_settings( $selected_id )
{
    ...
    if ( $selected_id ) record_status_list_row( _( "Customer status:" ), 'inactive' );
    ...
    if ( $dim >= 1 ) dimensions_list_row( _( "Dimension" ) . " 1:", 'dimension_id', $_POST[ 'dimension_id' ], true, " ", false, 1 );
    if ( $dim > 1 ) dimensions_list_row( _( "Dimension" ) . " 2:", 'dimension2_id', $_POST[ 'dimension2_id' ], true, " ", false, 2 );
...
if ( !$selected_id ) unset( $_POST[ '_tabs_sel' ] ); // force settings tab for new customer
