...
$page_security = 'SA_HRM_TERMINATION_ENTRY';
$path_to_root = "../..";
//----include files------------
...
$transaction_code = EMPLOYEE_TERMINATION;
//----message controller----
...
$arr = array('employee_id' => null,'first_name' => null,'unit_id' => $_POST['unit_id'],'department_id' => $_POST['department_id'], 
			  'employee_status_id' => array('table' => $prefix."employee",'label' => 'employee_status_id', 
			  								'value' => array( 
														array('operator' => $comparision_operator ,'attachment' => 'and','value' => employee_status_model::TERMINATED)
														)));
