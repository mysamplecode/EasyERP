...
$page_security = 'SA_HRM_INSTALLMENT_ENTRY';
$path_to_root = "../..";
//----include files------------
...
function can_process()
{
	...
	return 
			...
			((strcmp($Mode,'UPDATE_ITEM')==0)?1:!is_empty($_POST['installment'], ' New Installment'))  &&
			...
			(is_number($_POST['installment'], 'Installment'))   
			;
}
//---add item----------------
...
{
	if($_POST['installment'] > $_POST['remaining_advance'])
	{
		$msg = _("The Installment value cannot be greater then Remaining Advance.");
		display_error($msg);
	}
	else
	{
