 ...
 $cols = array(0,30);
  ...
  $new_cols[] = $us*$units_sizes;
	...
	$date = isset($_POST['SDate']) ? $_POST['SDate'] : null  ;
	 	$date_conds = '';
	if(isset($_POST['didSearch']))
	$date_conds = "and
	".TB_PREF."eresig.rdate like ".db_escape($date);
$sql = "SELECT   concat_ws(' ',".TB_PREF."employee.fname,".TB_PREF."employee.lname) as ename, ".TB_PREF."unit.name as uname,".TB_PREF."department.name as depname,".TB_PREF."designation.name as dname ,".TB_PREF."eresig.rr,".TB_PREF."eresig.rdate    from ".TB_PREF."employee inner join  ".TB_PREF."unit on ".TB_PREF."unit.id=".TB_PREF."employee.unitid  inner join ".TB_PREF."department on ".TB_PREF."department.id = ".TB_PREF."employee.depid inner join ".TB_PREF."designation on  ".TB_PREF."employee.desigid=".TB_PREF."designation.id inner join ".TB_PREF."eresig on  ".TB_PREF."eresig.eid=".TB_PREF."employee.id  where 
