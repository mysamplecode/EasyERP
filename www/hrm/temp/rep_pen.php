...
function print_units()
{
 ...
 $cols = array(0,30);
  ...
  $new_cols[] = $us*$units_sizes;
	...
	$lname = isset($_POST['SLv']) ? $_POST['SLv'] : null  ; 
	 	$date_conds = ''; 
  
$sql = "SELECT   concat_ws(' ',".TB_PREF."employee.fname,".TB_PREF."employee.lname) as ename, ".TB_PREF."unit.name as uname,".TB_PREF."department.name as depname,".TB_PREF."designation.name as dname ,".TB_PREF."leave.name as lname,".TB_PREF."epenal.no   from ".TB_PREF."employee inner join  ".TB_PREF."unit on ".TB_PREF."unit.id=".TB_PREF."employee.unitid  inner join ".TB_PREF."department on ".TB_PREF."department.id = ".TB_PREF."employee.depid inner join ".TB_PREF."designation on  ".TB_PREF."employee.desigid=".TB_PREF."designation.id inner join ".TB_PREF."epenal on  ".TB_PREF."epenal.eid=".TB_PREF."employee.id inner join ".TB_PREF."leave on ".TB_PREF."leave.id = ".TB_PREF."epenal.lid  where 
  ...
  ";
    ...
    $rep = new FrontReport(_('Penalty raports'), "Resignation raports", user_pagesize());
    $rep->Font();
