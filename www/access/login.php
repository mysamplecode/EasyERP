...
function defaultCompany()
{
	...
	if (!$login_timeout) { // FA logo
    	echo "<a target='_blank' href='$power_url'><img src='$path_to_root/themes/$def_theme/images/logo_ashtexsolutions_login.png' alt='Ashtex Solutions Ltd.' width = '273' height='178' onload='fixPNG(this)' border='0' /></a>";
	} else { 
