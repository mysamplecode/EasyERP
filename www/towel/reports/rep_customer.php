...
function print_units()
{
 ...
 $cols = array(0,30);
  ...
  foreach($size_arr as $us){
    ...
    $rep = new FrontReport(_('Towel customers'), "Towel customerss", user_pagesize());
    $rep->Font();
